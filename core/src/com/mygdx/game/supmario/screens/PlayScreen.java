package com.mygdx.game.supmario.screens;
...
import com.mygdx.game.supmario.actors.effects.BrickDebris;
import com.mygdx.game.supmario.actors.effects.Effect;
import com.mygdx.game.supmario.actors.effects.FlippingCoin;
import com.mygdx.game.supmario.actors.effects.SpawningEffect;
import com.mygdx.game.supmario.actors.enemies.Enemy;
import com.mygdx.game.supmario.actors.items.Flower;
import com.mygdx.game.supmario.actors.items.Item;
import com.mygdx.game.supmario.actors.items.Mushroom;
import com.mygdx.game.supmario.actors.items.SpawningItem;
import com.mygdx.game.supmario.actors.items.Star;
import com.mygdx.game.supmario.actors.maptiles.MapTileObject;
import com.mygdx.game.supmario.actors.stageitems.Flag;
import com.mygdx.game.supmario.actors.weapons.Fireball;
import com.mygdx.game.supmario.actors.weapons.SpawningFireball;
import com.mygdx.game.supmario.gamesys.GameManager;
import com.mygdx.game.supmario.hud.Hud;
import com.mygdx.game.supmario.hud.ScoreIndicator;
import com.mygdx.game.supmario.utils.WorldContactListener;
import com.mygdx.game.supmario.utils.WorldCreator;
...
//    private float mapHeight; // currently not used
    ...
    public void show() {
        ...
        textureAtlas = new TextureAtlas("mario/imgs/actors.atlas");
        ...
        tiledMap = tmxMapLoader.load("mario/maps/Level_1-1.tmx");
...
//        mapHeight = ((TiledMapTileLayer) tiledMap.getLayers().get(0)).getHeight(); // currently not used
        ...
        mario = new Mario(this, (worldCreator.getStartPosition().x) / GameManager.PPM, (worldCreator.getStartPosition().y) / GameManager.PPM);
