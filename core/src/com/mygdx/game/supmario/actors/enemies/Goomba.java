...
public class Goomba extends Enemy {
    ...
    public void update(float delta) {
        ...
        if (stomped) {
            ...
            GameManager.instance.getAssetManager().get("mario/audio/sfx/stomp.wav", Sound.class).play();
            ...
            GameManager.instance.getAssetManager().get("mario/audio/sfx/stomp.wav", Sound.class).play(volume, 1.0f, pan);
