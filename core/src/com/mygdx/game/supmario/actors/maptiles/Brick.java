...
import com.mygdx.game.supmario.actors.Collider;
        ...
        if (other.getFilter().categoryBits == GameManager.MARIO_HEAD_BIT) {
            ...
            if (multihit) {
                if (hitCount > 0) {
                    ...
                    GameManager.instance.getAssetManager().get("mario/audio/sfx/coin.wav", Sound.class).play();
                ...
                if (((Mario) other.getUserData()).isGrownUp()) {
                    GameManager.instance.getAssetManager().get("mario/audio/sfx/breakblock.wav", Sound.class).play();
                    ...
                    GameManager.instance.getAssetManager().get("mario/audio/sfx/bump.wav", Sound.class).play();
                    hit = true;
                    lethal = true;
                }
            }
